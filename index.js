...
Currently, ${unfundedSum <= 1 ? `1 game remains unfunded. We need your help to fund these amazing games!` : 
`${unfundedSum} games remain unfunded. We need your help to fund these amazing games!`}`;
